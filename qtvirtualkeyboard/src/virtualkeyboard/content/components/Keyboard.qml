...
Item {
    ...
    Loader {
        ...
        Item {
            ...
            height: Math.round(style.keyboardDesignHeight * width / style.keyboardDesignWidth) - 65
            ...
            Loader {
                ...
                anchors.bottomMargin: Math.round(style.keyboardRelativeBottomMargin * parent.height) - 25
